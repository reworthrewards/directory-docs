...
const Playground = () => {
    ...
    const copyClipboard = () => {
        setCopied(true)
        navigator.clipboard.writeText(`<iframe width="100%" height="100%" src="https://directory.reworth.app/?accentColor=${accentColor}&fontFamily=${fontFamily}&lang=${language}" frameBorder="0" loading="lazy" />`);
        setTimeout(() => {
            setCopied(false)
        }, 2500);
    }
    ...
    return(
        <Box className={styles.mainPadding} mb='3rem' w='100%' h='auto' bg='var(--ifm-color-primary-secondaryBg)' display='flex' flexDirection='column' >
                ...
                <Box w='100%' h='auto' pt='3rem' display='flex' alignItems='center' justifyContent='center' flexDirection='row' >
                    <div className={styles.gridParent} style={{ bg: 'red' }} >
                        <div className={styles.cardPlayground}>
                            ...
                            <Box w='100%' >
                                <input placeholder='#2e58ff' value={accentColor} maxLength={6} minLength={6} className={styles.input} onChange={(e) => handleHexColor(e.target.value)} />
                            </Box>
                            <Box pt='3rem' w='100%' display='flex' flexDirection='column'>
                                ...
                                <Box w='100%' borderLeftRadius='6px' borderRightRadius='6px' display='flex' flexDirection='row' className={styles.baseShadow}>
                                    <Box borderLeftRadius='6px' bg={fontFamily === 'Poppins' ? '#2e58ff' : null} onClick={() => setFontFamily('Poppins')} cursor='pointer' p='1rem' w='100%' display='flex' alignItems='center' justifyContent='center' >
                                        <Heading m='0px' className={styles.descCard} color={fontFamily === 'Poppins' ? 'white' : null} >
                                            Poppins
                                        </Heading>
                                    </Box>
                                    <Box bg={fontFamily === 'Montserrat' ? '#2e58ff' : null} onClick={() => setFontFamily('Montserrat')} cursor='pointer' p='1rem' w='100%' display='flex' alignItems='center' justifyContent='center' >
                                        <Heading m='0px' className={styles.descCard} color={fontFamily === 'Montserrat' ? 'white' : null}>
                                            Montserrat
                                        </Heading>
                                    </Box>
                                    <Box borderRightRadius='6px' bg={fontFamily === 'Gothic A1' ? '#2e58ff' : null} onClick={() => setFontFamily('Gothic A1')} cursor='pointer' p='1rem' w='100%' display='flex' alignItems='center' justifyContent='center' >
                            ...
                            <Box pt='3rem' w='100%' display='flex' flexDirection='column' >
                                ...
                                <Box w='100%' borderLeftRadius='6px' borderRightRadius='6px' display='flex' flexDirection='row' className={styles.baseShadow} >
                                    <Box borderLeftRadius='6px' onClick={() => setLang('ES')} bg={language === 'ES' ? '#2e58ff' : null} cursor='pointer' p='1rem' w='100%' display='flex' alignItems='center' justifyContent='center' >
                                        <Heading m='0px' className={styles.descCard} color={language === 'ES' ? 'white' : null}>
                                            Spanish
                                        </Heading>
                                    </Box>
                                    <Box borderRightRadius='6px' onClick={() => setLang('EN')} bg={language === 'EN' ? '#2e58ff' : null} cursor='pointer' p='1rem' w='100%' display='flex' alignItems='center' justifyContent='center' >
                                        <Heading m='0px' className={styles.descCard} color={language === 'EN' ? 'white' : null}>
                                            English
                                        </Heading>
                                    </Box>
                                </Box>
                        ...
                        <div className={styles.cardPlayground}>
                            <div className={isDarkTheme === true ? styles.phoneDark : styles.phoneLight}>
                                <div className={styles.iframeWrapper}>
                                    <iframe src={`https://dev.d1p65nyj9rmkp4.amplifyapp.com/?accentColor=${accentColor}&fontFamily=${fontFamily}&lang=${language}`} width='100%' height='100%' border='0px' loading="lazy" />     
                                </div>
                            </div>
                        </div>
                    </div>
